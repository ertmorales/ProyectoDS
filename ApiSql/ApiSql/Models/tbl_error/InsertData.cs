...
namespace ApiSql.Models.tbl_error
{
    public class InsertData
    {
        ...
        public int insertData_error(string name)
        {
            ...
            using (var connection = Connection.ConnectionSql.getConnection())
            {
                ...
                foreach (var row in listajson)
                {
                    ...
                    SqlDataAdapter cmd = new SqlDataAdapter("select Id from dbo.error where Id = " + row.Id, connection);
                ...
                using (SqlTransaction transaction = connection.BeginTransaction())
                {
                    using (var command = new SqlCommand())
                    {
                        ...
                        command.CommandText = "insert into dbo.error values (" +
                            "@Descripcion," +
                            "@UserName, " +
                            "@Fecha_Hora " +
                            ")";
                        ...
                        command.Parameters.Add("@Fecha_Hora", SqlDbType.VarChar);
                        ...
                        try
                        {
                            foreach (var item in objectDetailList)
                            {
                                ...
                                command.Parameters["@Fecha_Hora"].Value = item.Fecha_Hora;
