...
namespace ApiSql.Models.tbl_s_doc_t_tra
{
    public class InsertData
    {
        ...
        public int insertData_s_doc_t_tra(string name)
        {
            ...
            using (var connection = Connection.ConnectionSql.getConnection())
            {
                ...
                foreach (var row in listajson)
                {
                    ...
                    SqlDataAdapter cmd = new SqlDataAdapter("select Id from dbo.s_doc_t_tra where Id = " + row.Id, connection);
                ...
                using (SqlTransaction transaction = connection.BeginTransaction())
                {
                    using (var command = new SqlCommand())
                    {
                        ...
                        command.CommandText = "insert into dbo.s_doc_t_tra values (" +
                            "@Tipo_Documento," +
                            "@Serie_Documento," +
                            "@Empresa, " +
                            "@Tipo_Transaccion" +
