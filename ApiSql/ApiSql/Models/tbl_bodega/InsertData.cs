...
namespace ApiSql.Models.tbl_bodega
{
    public class InsertData
    {
       ...
       public int insertDataBodega(string name)
       {
            ...
            using (var connection = Connection.ConnectionSql.getConnection())
            {
                ...
                foreach (var row in listajson)
                {
                    ...
                    SqlDataAdapter cmd = new SqlDataAdapter("select Id from dbo.bodega where Id = " + row.Id, connection);
                ...
                using (SqlTransaction transaction = connection.BeginTransaction())
                {
                    using (var command = new SqlCommand())
                    {
                        ...
                        command.CommandText = "insert into dbo.bodega values (@Bodega, @Empresa, @Nombre)";
