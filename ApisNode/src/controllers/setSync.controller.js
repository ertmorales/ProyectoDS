                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        await insert_usuario(nameFiles[0].usuario, async function(resolve) {
                                                                                                                                                                                                                                            if (resolve) {
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                statusInsert.forEach(status => {
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    if (status === 1) {
                                                                                                                                                                                                                                                        _Message.push("File name not found (1)");
                                                                                                                                                                                                                                                        _Status.push(404);
                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                    if (status === 2) {
                                                                                                                                                                                                                                                        _Message.push("Error reading the file (2)");
                                                                                                                                                                                                                                                        _Status.push(404);
                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                    if (status === 3) {
                                                                                                                                                                                                                                                        _Message.push("Internal server error verifying existence of rows (3)");
                                                                                                                                                                                                                                                        _Status.push(500);
                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                    if (status === 4) {
                                                                                                                                                                                                                                                        _Message.push("Internal server error inserting rows (4)");
                                                                                                                                                                                                                                                        _Status.push(500);
                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                    if (status === 5) {
                                                                                                                                                                                                                                                        _Message.push("The data was not inserted because the data already exists in the destination table (5)");
                                                                                                                                                                                                                                                        _Status.push(200);
                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                    if (status === 6) {
                                                                                                                                                                                                                                                        _Message.push("No data available in table origin (6)");
                                                                                                                                                                                                                                                        _Status.push(404);
                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                    if (status === 7) {
                                                                                                                                                                                                                                                        _Message.push("Error in a function (7)");
                                                                                                                                                                                                                                                        _Status.push(500);
                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                    if (status === 8) {
                                                                                                                                                                                                                                                        _Message.push("Error in a function (8)");
                                                                                                                                                                                                                                                        _Status.push(500);
                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                    if (status === 201) {
                                                                                                                                                                                                                                                        _Message.push("Rows inserted successfully");
                                                                                                                                                                                                                                                        _Status.push(201);
                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                });
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                fs.writeFile(generalDir + dirSaveFile.informeInsert + name + ".json", text, function(err) {
                                                                                                                                                                                                                                                    if (err) {
                                                                                                                                                                                                                                                        console.log("Error al crear informe");
                                                                                                                                                                                                                                                    } else {
